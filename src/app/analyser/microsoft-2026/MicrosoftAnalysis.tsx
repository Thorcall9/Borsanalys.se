...
<div data-section="overview" id="overview" className="pt-14">
  ...
  <FinancialTable
    ...
    columns={[
      ...
      { key: "share", header: "Ägarandel" },
      { key: "category", header: "Kategori" },
    ]}
    rows={[
      { cells: { owner: { value: "Vanguard Group" }, share: { value: "~8,5%" }, category: { value: "Institutionell" } } },
      { cells: { owner: { value: "BlackRock" }, share: { value: "~7,0%" }, category: { value: "Institutionell" } } },
      { cells: { owner: { value: "State Street" }, share: { value: "~4,2%" }, category: { value: "Institutionell" } } },
      { cells: { owner: { value: "Satya Nadella" }, share: { value: "~0,06%" }, category: { value: "Insider" } } },
      { cells: { owner: { value: "Bill Gates (stiftelse)" }, share: { value: "~1,3%" }, category: { value: "Grundare" } } },
    ]}
  />
...
<div data-section="moat" id="moat" className="pt-14">
  ...
  <FinancialTable
    ...
    columns={[
      ...
      { key: "threat", header: "Hot mot MSFT" },
    ]}
    rows={[
      { cells: { competitor: { value: "Amazon (AWS)" }, strength: { value: "Störst molnaktör (~33%)" }, threat: { value: "Medel — Azure växer snabbare" } } },
      { cells: { competitor: { value: "Google (GCP)" }, strength: { value: "AI/ML-kapacitet" }, threat: { value: "Medel — Gemini vs Copilot" } } },
      { cells: { competitor: { value: "Salesforce" }, strength: { value: "CRM-dominans" }, threat: { value: "Låg — delvis partner" } } },
      { cells: { competitor: { value: "OpenAI" }, strength: { value: "AI-modeller" }, threat: { value: "Komplext — partner & potentiell konkurrent" } } },
    ]}
  />
...
<div data-section="growth" id="growth" className="pt-14">
  ...
  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-5 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Katalysatorer (12–24 månader)</h3>
  <FinancialTable
    title=""
    columns={[
    ...
    rows={[
      { cells: { catalyst: { value: "Copilot adoption-data Q3/Q4 2025" }, timing: { value: "6–9 mån" }, impact: { value: "Hög", color: "green" } } },
      { cells: { catalyst: { value: "Azure-tillväxt acceleration >25%" }, timing: { value: "Löpande" }, impact: { value: "Hög", color: "green" } } },
      { cells: { catalyst: { value: "M365 premium tier upsell" }, timing: { value: "12 mån" }, impact: { value: "Medel" } } },
      { cells: { catalyst: { value: "AI Agents kommersiell lansering" }, timing: { value: "12–18 mån" }, impact: { value: "Hög", color: "green" } } },
      { cells: { catalyst: { value: "Quantum computing milestones" }, timing: { value: "24+ mån" }, impact: { value: "Låg–Medel" } } },
    ]}
  />
</div>
...
<div data-section="esg" id="esg" className="pt-14">
  ...
  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-5 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Makroekonomiska faktorer</h3>
  <FinancialTable
    title=""
    columns={[
    ...
    rows={[
      { cells: { factor: { value: "Räntor (höga)" }, impact: { value: "Lägre multipelacceptans, men stark balansräkning skyddar" }, direction: { value: "Neutral/Negativ", color: "amber" } } },
      { cells: { factor: { value: "USD-styrka" }, impact: { value: "Pressar ex-USA intäkter i rapporterad valuta" }, direction: { value: "Negativ", color: "amber" } } },
      { cells: { factor: { value: "Enterprise IT-budget" }, impact: { value: "Stark p.g.a. AI-investeringar — ej konjunkturkänslig" }, direction: { value: "Positiv", color: "green" } } },
      { cells: { factor: { value: "AI-boom" }, impact: { value: "Direktpositiv för Azure, Copilot och all MSFT verksamhet" }, direction: { value: "Starkt positiv", color: "green" } } },
      { cells: { factor: { value: "Cloud-adoption" }, impact: { value: "Fortsatt migration från on-premise gynnar Azure" }, direction: { value: "Positiv", color: "green" } } },
      { cells: { factor: { value: "Geopolitik (Kina-USA)" }, impact: { value: "Risk för regionala restriktioner på cloud" }, direction: { value: "Negativ risk", color: "amber" } } },
    ]}
  />
</div>
...
<div data-section="ai-obs" id="ai-obs" className="pt-14">
  ...
  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-6 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Trendanalys & Sentimentmönster</h3>
  <p className="text-sm leading-relaxed text-[#2a2a2a] mb-3">
    <strong>Azure-kommentarer i intäktsrapporter:</strong> Managements ton kring Azure-kapacitetsbegränsningar är ett viktigt signal — de kommunicerade Q2/Q3 2025 att "efterfrågan överstiger kapaciteten" vilket är bullish för 2026 när ny kapacitet tas i drift. Historiskt har sådana kommentarer föregått acceleration i Azure-tillväxt.
  </p>
  <p className="text-sm leading-relaxed text-[#2a2a2a] mb-4">
    <strong>Copilot adoption-signal:</strong> CIO-undersökningar (Gartner, IDC) visar att Copilot-adoption är i tidig fas men accelererande. Bolag med 1 000+ anställda visar 40–60% awareness och 10–20% aktiv pilot. Nästa 12 månader är kritiska för konversion till betalande kunder.
  </p>

  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-5 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Avvikelser & Varningssignaler</h3>
  <AlertBox type="risk">
    <strong>⚠️ FCF-gap:</strong> Skillnaden mellan operativt kassaflöde ($160Mdr) och FCF ($77Mdr) har aldrig varit större. Capex/Operativt KF-kvoten är nu 52% — historiskt har denna kvot legat på 30–35%. En besvikelse i Azure under Q3/Q4 2025 kan orsaka signifikant marknadsnedgång.
  </AlertBox>
  <AlertBox type="info">
    <strong>⚠️ EPS-estimat 2026e:</strong> Analytikernas EPS-estimat för 2026 ($16,47) verkar konservativa relativt bolagets historiska beat-and-raise mönster. Microsoft har slagit EPS-estimat 15 kvartal i rad. Om detta håller finns upprevideringsrisk mot $17,50–18,00.
  </AlertBox>

  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-6 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Historisk analogi</h3>
  <p className="text-sm leading-relaxed text-[#2a2a2a] mb-4">
  ...
  <h3 className="text-xs font-bold text-[#1a3c6e] uppercase tracking-widest mt-5 mb-2 pl-2 border-l-[3px] border-[#b5892a]">Datapunkter att bevaka</h3>
  <FinancialTable
    title=""
    columns={[
    ...
    rows={[
      { cells: { datapoint: { value: "Azure growth rate" }, why: { value: "Primär värderingsdriver" }, frequency: { value: "Kvartalsvis" } } },
      { cells: { datapoint: { value: "Copilot seats" }, why: { value: "AI-monetarisering" }, frequency: { value: "Kvartalsvis" } } },
      { cells: { datapoint: { value: "Capex-guidance FY2026" }, why: { value: "FCF-påverkan" }, frequency: { value: "Kvartalsvis" } } },
      { cells: { datapoint: { value: "AI App-intäkter % av Azure" }, why: { value: "ROI-bevis" }, frequency: { value: "Kvartalsvis" } } },
      { cells: { datapoint: { value: "M365 ARPU-trend" }, why: { value: "Copilot upsell-signal" }, frequency: { value: "Kvartalsvis" } } },
      { cells: { datapoint: { value: "Security ARR-milstolpar" }, why: { value: "Underskattad tillväxtmotor" }, frequency: { value: "Halvårsvis" } } },
    ]}
  />
</div>
...
<div data-section="verdict" id="verdict" className="pt-14">
  ...
  <div className="bg-[#0f0f0f] text-[#faf8f3] rounded p-5 mb-5">
    ...
    <div className="flex flex-wrap gap-5">
      {[
        { label: "Analysdatum", value: "1 mars 2025" },
        { label: "Kurs vid analys", value: "$392" },
        { label: "Målpris (12–18 mån)", value: "$480" },
        { label: "Bull case", value: "$560" },
        { label: "Bear case", value: "$310" },
      ].map((kpi) => (
        <div key={kpi.label} className="border-l-2 border-[#b5892a] pl-2.5">
          <div className="text-[9px] text-[#808070] uppercase tracking-wide">{kpi.label}</div>
  ...
  <FinancialTable
    ...
    rows={[
      { cells: { criteria: { value: "Uthållig affärsmodell" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "SaaS/Cloud med hög inlåsning" } } },
      { cells: { criteria: { value: "Stark moat" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "Switching costs + nätverk + IP" } } },
      { cells: { criteria: { value: "Konsistent vinsttillväxt" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "15+ kvartals EPS-beats" } } },
      { cells: { criteria: { value: "Stark balansräkning" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "Nettoskuldfri, hög kassa" } } },
      { cells: { criteria: { value: "Hög kapitalavkastning" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "ROIC 25,6% >> WACC ~9%" } } },
      { cells: { criteria: { value: "Kompetent ledning" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "Nadella — world-class CEO" } } },
      { cells: { criteria: { value: "Attraktiv värdering" }, result: { value: "⚠️ Delvis", color: "amber" }, comment: { value: "Ej billig men rättfärdigad av kvalitet" } } },
      { cells: { criteria: { value: "5–10 år ägbarhet" }, result: { value: "✅ Ja", color: "green" }, comment: { value: "AI + Cloud = generationsskifte" } } },
    ]}
  />
...
<div data-section="scenarios" id="scenarios" className="pt-14">
  ...
  <div className="space-y-3 mb-5">
    {[
      { label: "Bull case ($560)", pct: 25, color: "#1a6e3c", textColor: "text-[#1a6e3c]" },
      { label: "Base case ($480)", pct: 55, color: "#1a3c6e", textColor: "text-[#1a3c6e]" },
      { label: "Bear case ($310)", pct: 20, color: "#8b1a1a", textColor: "text-[#8b1a1a]" },
    ].map((item) => (
      <div key={item.label}>
